...
##### removing the product Type attribute , since it has 600 uniques values and it is a  multivalued attribute so it has to be removed from the dataset because the information gain and gini index are biased towards unique and multivalued attributes.

```{r}
new_dataset$Product = NULL
```
